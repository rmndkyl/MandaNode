...
install_prereqs() {
    ...
    nvm install v22.10.0 > /dev/null 2>&1
    nvm use v22.10.0 > /dev/null 2>&1

    # Set nodejs v22.10.0 as default and link node to /usr/bin/
    nvm alias default 22.10.0 > /dev/null 2>&1
