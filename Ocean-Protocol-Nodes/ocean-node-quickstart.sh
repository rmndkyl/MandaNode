    ...
    environment:
      ...
      RPCS: '{
        "1": {
          ...
          "fallbackRPCs": ["https://rpc.ankr.com/eth", "https://1rpc.io/eth", "https://eth.api.onfinality.io/public", "https://ethereum-rpc.publicnode.com"],
          "chainId": 1,
          "network": "mainnet",
          "chunkSize": 100
        },
        "10": {
          ...
          "fallbackRPCs": ["https://optimism-mainnet.public.blastapi.io", "https://rpc.ankr.com/optimism", "https://optimism-rpc.publicnode.com", "https://mainnet.optimism.io"],
          "chainId": 10,
          "network": "optimism",
          "chunkSize": 100
        },
        "137": {
          ...
          "fallbackRPCs": ["https://polygon-mainnet.public.blastapi.io", "https://1rpc.io/matic", "https://rpc.ankr.com/polygon", "https://polygon-rpc.com/"],
          "chainId": 137,
          "network": "polygon",
          "chunkSize": 100
        },
        ...
        "11155111": {
          ...
          "fallbackRPCs": ["https://1rpc.io/sepolia", "https://eth-sepolia.g.alchemy.com/v2/demo", "https://eth-sepolia.public.blastapi.io"],
          "chainId": 11155111,
          "network": "sepolia",
          "chunkSize": 100
        },
        "11155420": {
          ...
          "fallbackRPCs": ["https://endpoints.omniatech.io/v1/op/sepolia/public", "https://optimism-sepolia.blockpi.network/v1/rpc/public", "https://sepolia.optimism.io"],
          "chainId": 11155420,
